...
<script>
	...
	function montarParedao(){
		jQuery("#paredao").html("<div class='vertical-align'><span class='label label-default'>Carregando paredão ...</span></div>");
		jQuery("#paredao").load('paredao.php');
	}

    //Metodo Ajax para montar a lista das tops
	function montarTop20(){
		jQuery("#top20").html("<div class='vertical-align'><span class='label label-default'>Carregando top 20 ...</span></div>");
